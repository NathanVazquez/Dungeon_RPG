...
Tor Sdayur
November 2023
Defined data members main_character_ and combat_queue_.
...
class Tavern : public ArrayBag<Character*>{
  public:
    ...
    */
     ...
     */
    void setMainCharacter(Character* char_ptr);
     ...
     */
    bool levelIsLess(Character* char_lhs_ptr, Character* char_rhs_ptr) const;

    /**
     * @param: two Character pointers
     * @return: true if the lhs Character's level is greater than the rhs Character's level
     */
    bool levelIsGreater(Character* char_lhs_ptr, Character* char_rhs_ptr) const;

    /**
     * @param: two Character pointers
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     * @return: true if the lhs Character's vitality is less than the rhs Character's vitality
     */
    bool vitalityIsLess(Character* char_lhs_ptr, Character* char_rhs_ptr) const;

    /**
     * @param: two Character pointers
     * @return: true if the lhs Character's vitality is more than the rhs Character's vitality
     */
    bool vitalityIsGreater(Character* char_lhs_ptr, Character* char_rhs_ptr) const;
     ...
     *         : \n(YOU) [MAINCHARACTER NAME]: LEVEL [MAINCHARACTER LEVEL] [MAINCHARACTER RACE]. \nVITALITY: [MAINCHARACTER VITALITY] \nARMOR: [MAINCHARACTER ARMOR]\n
     */
    void enemyTurn(Character* enemy_ptr);
  ...
  private:
    ...
    */
	 ...
	 */
	void printAction(Character* char_ptr, int action);

	//pointer to main character
	Character* main_character_;
	//A combat queue of Character pointers i.e. enemies that the main character must fight.
