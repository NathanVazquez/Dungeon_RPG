...
void Scoundrel::eatTaintedStew() 
{
    if (getRace() == "UNDEAD"){
        ...
        //" they have a 70% chance of recovering 4 Vitality points,
        // but a 30% chance of resetting their Vitality to 1, 
        
        //and they lose their daggers, which are replaced with WOOD daggers. (If their daggers were already WOOD, nothing happens to the daggers). "
        }
    }
