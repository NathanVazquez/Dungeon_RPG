...
Tor Sdayur
November 2023
Implemented methods heal, mendMetal, strick, and throwTomato.
*/
 ...
 */
void Character::setActionQueue(const std::queue<int>& action_queue)
{
 ...
 * @post : sets the data member action_queue_ to the value of the parameter.
 */
void Character::setBuffStack(const std::stack<Buff>& buff_stack)
{
	buff_stack_ = buff_stack;
}
 ...
 */
void Character::strike(Character* char_ptr)
{
	if (char_ptr->armor_ >= 2)
	{
		char_ptr->armor_ -= 2;
	}
	else if (char_ptr->armor_ == 1)
	{
		char_ptr->armor_--;
		char_ptr->vitality_--;
	}
 ...
 */
void Character::throwTomato(Character* char_ptr)
{
	if (char_ptr->armor_ >= 1)
	{
		char_ptr->armor_--;
	}
	else
